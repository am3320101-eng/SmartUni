...
public class AIInteractionService {
    ...
    private final AISearchClientService aiClient;  // ✅ جديد - ربط مع AI
    ...
    public AIInteractionDto ask(AIInteractionDto dto) {
        ...
        // ✅ غيّرنا من placeholder لـ AI حقيقي
        String generatedAnswer = aiClient.askAI(dto.getQuestion(), dto.getStudentId());
